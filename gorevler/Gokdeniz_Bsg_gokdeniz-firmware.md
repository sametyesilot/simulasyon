# Zararlı Firmware Güncellemesi - Test Görevi

**Sorumlu:** Gokdeniz_Bsg
**Kategori:** Firmware

## 1. Amaç
Bu döküman, "Zararlı Firmware Güncellemesi" anomalisinin platform üzerinde nasıl simüle edileceğini ve tespit edileceğini açıklar.

## 2. Kurulum Gerekmeden Test (UI Kullanımı)
1. Platform anasayfasına gidin (Deploy linki veya Localhost).
2. Listeden **Gokdeniz_Bsg** filtresini seçin.
3. **Zararlı Firmware Güncellemesi** kartını bulun.
4. "Start Simulation" butonuna tıklayın.
5. Açılan ekranda logları ve metrikleri izleyin.

## 3. Beklenen Çıktılar
- **Loglar:** Unexpected Fw Version, Reboot Loops, Failed Verify içeren uyarılar görülmeli.
