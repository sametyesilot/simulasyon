# Firmware Supply Chain Attack - Test Görevi

**Sorumlu:** Mirac_BSG
**Kategori:** Firmware/SupplyChain

## 1. Amaç
Bu döküman, "Firmware Supply Chain Attack" anomalisinin platform üzerinde nasıl simüle edileceğini ve tespit edileceğini açıklar.

## 2. Kurulum Gerekmeden Test (UI Kullanımı)
1. Platform anasayfasına gidin (Deploy linki veya Localhost).
2. Listeden **Mirac_BSG** filtresini seçin.
3. **Firmware Supply Chain Attack** kartını bulun.
4. "Start Simulation" butonuna tıklayın.
5. Açılan ekranda logları ve metrikleri izleyin.

## 3. Beklenen Çıktılar
- **Loglar:** Unauthorized Outbound Traffic, Hidden Admin Accounts içeren uyarılar görülmeli.
