# Enerji Hırsızlığı / Sayaç Manipülasyonu - Test Görevi

**Sorumlu:** Samet_BSG
**Kategori:** Data Integrity

## 1. Amaç
Bu döküman, "Enerji Hırsızlığı / Sayaç Manipülasyonu" anomalisinin platform üzerinde nasıl simüle edileceğini ve tespit edileceğini açıklar.

## 2. Kurulum Gerekmeden Test (UI Kullanımı)
1. Platform anasayfasına gidin (Deploy linki veya Localhost).
2. Listeden **Samet_BSG** filtresini seçin.
3. **Enerji Hırsızlığı / Sayaç Manipülasyonu** kartını bulun.
4. "Start Simulation" butonuna tıklayın.
5. Açılan ekranda logları ve metrikleri izleyin.

## 3. Beklenen Çıktılar
- **Loglar:** Metervals < Physical Consumption, Signature Failures içeren uyarılar görülmeli.
